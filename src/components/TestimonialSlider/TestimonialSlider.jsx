...
export default function TestimonialSlider() {
    const [isVisibleIndex, setIsVisibleIndex] = useState(2);
    const testimonials = [
        {
    ...
    const testimonialsList = testimonials.map((testimonial, index) => {
        return (
            index < isVisibleIndex && (
                <li key={index} className="basis-2/4">
                    <p>&quot;{testimonial.text}&quot;</p>
                    <div className="flex justify-center">
                        <Image src="" alt="Serenity Home Repair Logo"></Image>
                        <div>
    ...
    return (
        <div className="bg-slate-400">
            <div className="container mx-auto">
                <h1 className="text-center">Our clients love us.</h1>
                <div className="flex">
                    <p>←</p>
                    <ul className="flex">{testimonialsList}</ul>
                    <p>→</p>
                </div>
            </div>
        </div>

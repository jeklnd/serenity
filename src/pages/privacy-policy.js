...
export default function PrivacyPolicy() {
    return (
        <div className="flex justify-center p-2">
            ...
            />
            <div data-custom-class="body" className="flex flex-col container">
                <div>
                    <strong>
                        ...
                        <strong>
                            <span style={{ fontSize: 15 }}>
                                <span data-custom-class="subtitle">
                                    Last updated{" "}
                                    <bdt className="question">May 01, 2023</bdt>
                                </span>
                            </span>
                        </strong>
                    </span>
                        ...
                        >
                            <span data-custom-class="body_text">
                                ...
                                <bdt className="question">
                                    Katapault, LLC
                                    <bdt className="block-component" /> (doing
                                    business as{" "}
                                    <bdt className="question">
                        ...
                        >
                            ...
                            >
                                <span data-custom-class="body_text">
                                    ...
                                    <bdt className="question">
                                        <a
                                            href="https://serenityhomerepair.com/"
                                            target="_blank"
                ...
                <div>
                    ...
                    <div style={{ lineHeight: "1.5" }}>
                        <span style={{ fontSize: 15 }}>
                            <span data-custom-class="body_text">
                                ...
                                <bdt className="else-block" /> and the Services,
                    ...
                    <div style={{ lineHeight: "1.5" }}>
                        ...
                        <a
                            data-custom-class="link"
                            href="https://app.termly.io/notify/a2a3cf26-9fe6-4f93-99ec-20859c1b64d0"
                                    ...
                                    >
                                        ...
                                        >
                                            <span data-custom-class="body_text">
                                                ...
                                                out, you may not be able to use
